...
export const APP_CONTENT = {
  ...
  support: {
    TRIGGER_BTN: "Support",
    MODAL_TITLE: "How can we help?",
    MODAL_DESC: "Found a bug or have a feature request? Let us know.",
    LABEL_SUBJECT: "Subject",
    LABEL_CATEGORY: "Category",
    LABEL_MESSAGE: "Message",
    PLACEHOLDER_SUBJECT: "Brief summary of the issue",
    PLACEHOLDER_MESSAGE: "Describe what happened...",
    BTN_SUBMIT: "Submit Ticket",
    BTN_SUBMITTING: "Sending...",
    TOAST_SUCCESS: "Ticket Received",
    TOAST_DESC: "We'll get back to you shortly.",
    categories: [
